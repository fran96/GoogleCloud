...
namespace Website.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            //call datastorecontroller create method
            ...
            claimsIdentity.AddClaim(
                new Claim(
                    ClaimTypes.Name, loginInfo.ExternalIdentity.Name,
            ...
            //add eventually the roles that have been allocated to the user
        ...
        {
            DataStoreController dsc = new DataStoreController();
            dsc.LogOut(User.Identity.Name);
            AuthenticationManager.SignOut(DefaultAuthenticationTypes.ApplicationCookie);
